...
public sealed partial class DoorBoltComponent : Component
{
    ...
    public SoundSpecifier BoltUpSound = new SoundPathSpecifier("/Audio/_Funkystation/Machines/boltsup.ogg"); /// Euphoria - New door sounds from Funky

    /// <summary>
    /// Sound to play when the bolts on the airlock go down.
    /// </summary>
    [DataField, ViewVariables(VVAccess.ReadWrite)]
    public SoundSpecifier BoltDownSound = new SoundPathSpecifier("/Audio/_Funkystation/Machines/boltsdown.ogg"); /// Euphoria - New door sounds from Funky
